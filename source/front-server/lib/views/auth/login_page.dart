...
class AppStrings {
  const AppStrings({
    ...
    required this.serverNotFound,
    required this.serverNotFoundDetail,
    required this.retry,
    required this.noAccount,
    required this.register,
    required this.registrationTitle,
    required this.registrationSubtitle,
  ...
  factory AppStrings.fromLocale(Locale locale) {
    if (locale.languageCode.toLowerCase() == 'es') {
      return const AppStrings(
        ...
        serverNotFoundDetail: 'El servidor local no está en ejecución.',
        retry: 'Reintentar',
        noAccount: '¿No tienes una cuenta?',
        register: 'Registrarse',
        registrationTitle: 'Registro de administrador',
        registrationSubtitle: 'Completa los datos para crear tu cuenta.',
        fullName: 'Nombre completo',
        fullNameHint: 'p. ej., Jane Doe',
        usernameHint: 'jane.doe',
        ...
        usernameTaken: 'Ese nombre de usuario ya está registrado.',
        registrationError: 'No se pudo crear la cuenta.',
    ...
    return const AppStrings(
      ...
      serverNotFoundDetail: 'The local server is not running.',
      retry: 'Retry',
      noAccount: "Don't have an account?",
      register: 'Register',
      registrationTitle: 'Admin Registration',
      registrationSubtitle: 'Complete the details to create your account.',
      fullName: 'Full Name',
      fullNameHint: 'e.g. Jane Doe',
      usernameHint: 'jane.doe',
      ...
      registrationError: 'The account could not be created.',
  ...
  final String serverNotFound;
  final String serverNotFoundDetail;
  final String retry;
  final String noAccount;
  final String register;
  final String registrationTitle;
  final String registrationSubtitle;
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _submit() async {
    if (_submitting || widget.onSignIn == null) return;
    FocusScope.of(context).unfocus();
    if (_usernameController.text.trim().isEmpty ||
        _passwordController.text.isEmpty) {
      setState(() => _error = widget.strings.fillAllFields);
      return;
    }
    setState(() {
      _submitting = true;
    ...
    try {
      ...
      if (mounted) {
        setState(
          () => _error = error.toString().contains('INVALID_CREDENTIALS')
              ? widget.strings.invalidCredentials
